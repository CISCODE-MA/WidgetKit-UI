...
const kindStyles: Record<NotificationKind, { bg: string; icon: React.ReactNode }> = {
  info: {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#3C50E0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  success: {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#219653" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  warning: {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#FFA70B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2">
                          <p className="text-xs font-semibold text-black dark:text-white leading-snug">{title}</p>
                          {unread && <span className="mt-0.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />}
                        </div>
                        <p className="mt-0.5 text-xs text-body dark:text-bodydark line-clamp-2 leading-relaxed">{description}</p>
